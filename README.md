...
| SimplE                         | [`pykeen.nn.modules.SimplEInteraction`](https://pykeen.readthedocs.io/en/latest/api/pykeen.nn.modules.SimplEInteraction.html)                       |                                                                                                                    |
| TorusE                         | [`pykeen.nn.modules.TorusEInteraction`](https://pykeen.readthedocs.io/en/latest/api/pykeen.nn.modules.TorusEInteraction.html)                       |                                                                                                                    |
| TransD                         | [`pykeen.nn.modules.TransDInteraction`](https://pykeen.readthedocs.io/en/latest/api/pykeen.nn.modules.TransDInteraction.html)                       |                                                                                                                    |
...
| TransH                         | [`pykeen.nn.modules.TransHInteraction`](https://pykeen.readthedocs.io/en/latest/api/pykeen.nn.modules.TransHInteraction.html)                       |                                                                                                                    |
| TransR                         | [`pykeen.nn.modules.TransRInteraction`](https://pykeen.readthedocs.io/en/latest/api/pykeen.nn.modules.TransRInteraction.html)                       |                                                                                                                    |
...
| Tucker                         | [`pykeen.nn.modules.TuckerInteraction`](https://pykeen.readthedocs.io/en/latest/api/pykeen.nn.modules.TuckerInteraction.html)                       |                                                                                                                    |
| UM                             | [`pykeen.nn.modules.UMInteraction`](https://pykeen.readthedocs.io/en/latest/api/pykeen.nn.modules.UMInteraction.html)                               |                                                                                                                    |

...
| InfoNCE loss with additive margin    | [`pykeen.losses.InfoNCELoss`](https://pykeen.readthedocs.io/en/latest/api/pykeen.losses.InfoNCELoss.html)                       | An implementation of the InfoNCE loss with additive margin proposed by [wang2022]_.                   |

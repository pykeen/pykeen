...
|---------------------------------------------|----------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------|
| AUC-ROC                                     | The area under the ROC curve, on [0, 1]. Higher is better.                             | [`pykeen.evaluation.SklearnMetricResults`](https://pykeen.readthedocs.io/en/latest/api/pykeen.evaluation.SklearnMetricResults.html)     |
| Adjusted Arithmetic Mean Rank (AAMR)        | The mean over all chance-adjusted ranks, on (0, 2). Lower is better.                   | [`pykeen.evaluation.RankBasedMetricResults`](https://pykeen.readthedocs.io/en/latest/api/pykeen.evaluation.RankBasedMetricResults.html) |
| Adjusted Arithmetic Mean Rank Index (AAMRI) | The re-indexed adjusted mean rank (AAMR), on [-1, 1]. Higher is better.                | [`pykeen.evaluation.RankBasedMetricResults`](https://pykeen.readthedocs.io/en/latest/api/pykeen.evaluation.RankBasedMetricResults.html) |
| Average Precision                           | The area under the precision-recall curve, on [0, 1]. Higher is better.                | [`pykeen.evaluation.SklearnMetricResults`](https://pykeen.readthedocs.io/en/latest/api/pykeen.evaluation.SklearnMetricResults.html)     |
| Geometric Mean Rank (GMR)                   | The geometric mean over all ranks, on [1, inf). Lower is better.                       | [`pykeen.evaluation.RankBasedMetricResults`](https://pykeen.readthedocs.io/en/latest/api/pykeen.evaluation.RankBasedMetricResults.html) |
| Harmonic Mean Rank (HMR)                    | The harmonic mean over all ranks, on [1, inf). Lower is better.                        | [`pykeen.evaluation.RankBasedMetricResults`](https://pykeen.readthedocs.io/en/latest/api/pykeen.evaluation.RankBasedMetricResults.html) |
...
| Inverse Arithmetic Mean Rank (IAMR)         | The inverse of the arithmetic mean over all ranks, on (0, 1]. Higher is better.        | [`pykeen.evaluation.RankBasedMetricResults`](https://pykeen.readthedocs.io/en/latest/api/pykeen.evaluation.RankBasedMetricResults.html) |
| Inverse Geometric Mean Rank (IGMR)          | The inverse of the geometric mean over all ranks, on (0, 1]. Higher is better.         | [`pykeen.evaluation.RankBasedMetricResults`](https://pykeen.readthedocs.io/en/latest/api/pykeen.evaluation.RankBasedMetricResults.html) |
| Inverse Median Rank                         | The inverse of the median over all ranks, on (0, 1]. Higher is better.                 | [`pykeen.evaluation.RankBasedMetricResults`](https://pykeen.readthedocs.io/en/latest/api/pykeen.evaluation.RankBasedMetricResults.html) |
| Mean Rank (MR)                              | The arithmetic mean over all ranks on, [1, inf). Lower is better.                      | [`pykeen.evaluation.RankBasedMetricResults`](https://pykeen.readthedocs.io/en/latest/api/pykeen.evaluation.RankBasedMetricResults.html) |
| Mean Reciprocal Rank (MRR)                  | The inverse of the harmonic mean over all ranks, on (0, 1]. Higher is better.          | [`pykeen.evaluation.RankBasedMetricResults`](https://pykeen.readthedocs.io/en/latest/api/pykeen.evaluation.RankBasedMetricResults.html) |
| Median Rank                                 | The median over all ranks, on [1, inf). Lower is better.                               | [`pykeen.evaluation.RankBasedMetricResults`](https://pykeen.readthedocs.io/en/latest/api/pykeen.evaluation.RankBasedMetricResults.html) |
| Rank Median Absolute Deviation              | The median absolute deviation over all ranks on, [0, inf). Lower is better.            | [`pykeen.evaluation.RankBasedMetricResults`](https://pykeen.readthedocs.io/en/latest/api/pykeen.evaluation.RankBasedMetricResults.html) |
| Rank Standard Deviation                     | The standard deviation over all ranks on, [0, inf). Lower is better.                   | [`pykeen.evaluation.RankBasedMetricResults`](https://pykeen.readthedocs.io/en/latest/api/pykeen.evaluation.RankBasedMetricResults.html) |
| Rank Variance                               | The variance over all ranks on, [0, inf). Lower is better.                             | [`pykeen.evaluation.RankBasedMetricResults`](https://pykeen.readthedocs.io/en/latest/api/pykeen.evaluation.RankBasedMetricResults.html) |

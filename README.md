...
|--------------------------------------|---------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------|
| adversarial                          | [`pykeen.losses.AdversarialLoss`](https://pykeen.readthedocs.io/en/latest/api/pykeen.losses.AdversarialLoss.html)               | A loss with adversarial weighting of negative samples.                                                |
| adversarialbce                       | [`pykeen.losses.AdversarialBCELoss`](https://pykeen.readthedocs.io/en/latest/api/pykeen.losses.AdversarialBCELoss.html)         | An adversarially weighted BCE loss.                                                                   |

...
| multi       | [`pykeen.trackers.MultiResultTracker`](https://pykeen.readthedocs.io/en/latest/api/pykeen.trackers.MultiResultTracker.html)             | A result tracker which delegates to multiple different result trackers. |

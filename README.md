...
The following 39 datasets are built in to PyKEEN. The citation for each dataset corresponds to either the paper
...
| FB15k-237 with numeric literals    | [`pykeen.datasets.FB15k237WithLiterals`](https://pykeen.readthedocs.io/en/latest/api/pykeen.datasets.FB15k237WithLiterals.html) | [Agustinus kristiadi et al. *et al*., 2018](https://arxiv.org/abs/1802.00934)                                           |      14505 |         237 |    310079 |
...
| YAGO3-10 with numeric literals     | [`pykeen.datasets.YAGO310WithLiterals`](https://pykeen.readthedocs.io/en/latest/api/pykeen.datasets.YAGO310WithLiterals.html)   | [Agustinus kristiadi et al. *et al*., 2018](https://arxiv.org/abs/1802.00934)                                           |     123143 |          37 |   1089000 |

...
|---------------------------------|-------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------|------------|-------------|-----------|
| Clinical Knowledge Graph        | [`:class:`pykeen.datasets.CKG``](https://pykeen.readthedocs.io/en/latest/api/:class:`pykeen.datasets.CKG`.html)                     | [Santos *et al*., 2020](https://doi.org/10.1101/2020.05.09.084897) |    7600000 |          11 |  26000000 |
| codexlarge                      | [`:class:`pykeen.datasets.CoDExLarge``](https://pykeen.readthedocs.io/en/latest/api/:class:`pykeen.datasets.CoDExLarge`.html)       | The CoDEx large dataset.                                           |            |             |           |
| codexmedium                     | [`:class:`pykeen.datasets.CoDExMedium``](https://pykeen.readthedocs.io/en/latest/api/:class:`pykeen.datasets.CoDExMedium`.html)     | The CoDEx medium dataset.                                          |            |             |           |
| codexsmall                      | [`:class:`pykeen.datasets.CoDExSmall``](https://pykeen.readthedocs.io/en/latest/api/:class:`pykeen.datasets.CoDExSmall`.html)       | The CoDEx small dataset.                                           |            |             |           |
| conceptnet                      | [`:class:`pykeen.datasets.ConceptNet``](https://pykeen.readthedocs.io/en/latest/api/:class:`pykeen.datasets.ConceptNet`.html)       | The ConceptNet dataset from [speer2017]_.                          |            |             |           |
| cskg                            | [`:class:`pykeen.datasets.CSKG``](https://pykeen.readthedocs.io/en/latest/api/:class:`pykeen.datasets.CSKG`.html)                   | The CSKG dataset.                                                  |            |             |           |
| dbpedia50                       | [`:class:`pykeen.datasets.DBpedia50``](https://pykeen.readthedocs.io/en/latest/api/:class:`pykeen.datasets.DBpedia50`.html)         | The DBpedia50 dataset.                                             |            |             |           |
| drkg                            | [`:class:`pykeen.datasets.DRKG``](https://pykeen.readthedocs.io/en/latest/api/:class:`pykeen.datasets.DRKG`.html)                   | The DRKG dataset.                                                  |            |             |           |
| FB15k                           | [`:class:`pykeen.datasets.FB15k``](https://pykeen.readthedocs.io/en/latest/api/:class:`pykeen.datasets.FB15k`.html)                 |                                                                    |      14951 |        1345 |    592213 |
| FB15k-237                       | [`:class:`pykeen.datasets.FB15k237``](https://pykeen.readthedocs.io/en/latest/api/:class:`pykeen.datasets.FB15k237`.html)           |                                                                    |      14505 |         237 |    310079 |
| hetionet                        | [`:class:`pykeen.datasets.Hetionet``](https://pykeen.readthedocs.io/en/latest/api/:class:`pykeen.datasets.Hetionet`.html)           | The Hetionet dataset is a large biological network.                |            |             |           |
| Kinships                        | [`:class:`pykeen.datasets.Kinships``](https://pykeen.readthedocs.io/en/latest/api/:class:`pykeen.datasets.Kinships`.html)           |                                                                    |        104 |          25 |     10686 |
| Nations                         | [`:class:`pykeen.datasets.Nations``](https://pykeen.readthedocs.io/en/latest/api/:class:`pykeen.datasets.Nations`.html)             |                                                                    |         14 |          55 |      1992 |
| ogbbiokg                        | [`:class:`pykeen.datasets.OGBBioKG``](https://pykeen.readthedocs.io/en/latest/api/:class:`pykeen.datasets.OGBBioKG`.html)           | The OGB BioKG dataset.                                             |            |             |           |
| ogbwikikg                       | [`:class:`pykeen.datasets.OGBWikiKG``](https://pykeen.readthedocs.io/en/latest/api/:class:`pykeen.datasets.OGBWikiKG`.html)         | The OGB WikiKG dataset.                                            |            |             |           |
| openbiolink                     | [`:class:`pykeen.datasets.OpenBioLink``](https://pykeen.readthedocs.io/en/latest/api/:class:`pykeen.datasets.OpenBioLink`.html)     | The OpenBioLink dataset.                                           |            |             |           |
| openbiolinkf1                   | [`:class:`pykeen.datasets.OpenBioLinkF1``](https://pykeen.readthedocs.io/en/latest/api/:class:`pykeen.datasets.OpenBioLinkF1`.html) | The PyKEEN First Filtered OpenBioLink 2020 Dataset.                |            |             |           |
| openbiolinkf2                   | [`:class:`pykeen.datasets.OpenBioLinkF2``](https://pykeen.readthedocs.io/en/latest/api/:class:`pykeen.datasets.OpenBioLinkF2`.html) | The PyKEEN Second Filtered OpenBioLink 2020 Dataset.               |            |             |           |
| openbiolinklq                   | [`:class:`pykeen.datasets.OpenBioLinkLQ``](https://pykeen.readthedocs.io/en/latest/api/:class:`pykeen.datasets.OpenBioLinkLQ`.html) | The low-quality variant of the OpenBioLink dataset.                |            |             |           |
| Unified Medical Language System | [`:class:`pykeen.datasets.UMLS``](https://pykeen.readthedocs.io/en/latest/api/:class:`pykeen.datasets.UMLS`.html)                   |                                                                    |        135 |          46 |      6529 |
| WordNet-18                      | [`:class:`pykeen.datasets.WN18``](https://pykeen.readthedocs.io/en/latest/api/:class:`pykeen.datasets.WN18`.html)                   |                                                                    |      40943 |          18 |    151442 |
| WordNet-18 (RR)                 | [`:class:`pykeen.datasets.WN18RR``](https://pykeen.readthedocs.io/en/latest/api/:class:`pykeen.datasets.WN18RR`.html)               |                                                                    |      40559 |          11 |     92583 |
| YAGO3-10                        | [`:class:`pykeen.datasets.YAGO310``](https://pykeen.readthedocs.io/en/latest/api/:class:`pykeen.datasets.YAGO310`.html)             |                                                                    |     123143 |          37 |   1089000 |

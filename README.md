...
|---------------------------------|----------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------|
| AUC-ROC                         | The area under the ROC curve, on [0.0, 1.0]. Higher is better.                         | [`pykeen.evaluation.SklearnMetricResults`](https://pykeen.readthedocs.io/en/latest/api/pykeen.evaluation.SklearnMetricResults.html)     |

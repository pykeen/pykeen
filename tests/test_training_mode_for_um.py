...
CONFIG = dict(
    ...
    random_seed=0,
    kg_embedding_model_name=pkc.UM_NAME,
    embedding_dim=50,
...
class TestTrainingModeForUM(unittest.TestCase):
    ...
    def test_training(self):
        """Test that UM is trained correctly in training mode."""
        results = pykeen.run(
            config=CONFIG,
    ...
    def test_evaluation(self):
        """Test that UM is trained and evaluated correctly in training mode. """

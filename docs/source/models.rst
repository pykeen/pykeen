...
in your configuration dictionary the values for each hyper-parameter. In case you define your experiment through the CLI,
PyKEEN will ensure that a correct configuration is created.

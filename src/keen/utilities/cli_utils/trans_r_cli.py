...
from keen.constants import MARGIN_LOSS_PRINT_MSG, MARGIN_LOSS_PROMPT_MSG, MARGIN_LOSS_ERROR_MSG, \
    SCORING_FUNCTION_PRINT_MSG, \
    SCORING_FUNCTION_PROMPT_MSG, SCORING_FUNCTION_ERROR_MSG, LEARNING_RATE_PRINT_MSG, \
    ...
    LEARNING_RATE, BATCH_SIZE, NUM_EPOCHS, KG_EMBEDDING_MODEL_NAME, MARGIN_LOSS, \
...
from keen.utilities.cli_utils.cli_print_msg_helper import print_training_margin_loss_message, print_scoring_fct_message, \
...
def configure_trans_r_training_pipeline(model_name):
    ...
    embedding_dimension = select_integer_value(print_msg=ENTITIES_EMBEDDING_DIMENSION_PRINT_MSG,
...
def configure_trans_r_hpo_pipeline():
    pass

...
class TokenizationRepresentation(Representation):
    ...
    def __init__(
        self,
        assignment: torch.LongTensor,
        token_representation: Optional[HintOrType[Representation]] = None,
...
class NodePieceRepresentation(CombinedRepresentation):
    ...
    def __init__(
        ...
        *,
        ...
        token_representations: Optional[OneOrManyHintOrType[Representation]] = None,
        token_representations_kwargs: Optional[OneOrManyOptionalKwargs] = None,
        tokenizers: Optional[OneOrManyHintOrType[Tokenizer]] = None,
        tokenizers_kwargs: Optional[OneOrManyOptionalKwargs] = None,

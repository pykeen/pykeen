...
class MessagePassingRepresentation(Representation, ABC):
    ...
    def __init__(
        ...
        layers_kwargs: Optional[OneOrManyOptionalKwargs] = None,
        base: Optional[HintOrType[Representation]] = None,
        base_kwargs: OptionalKwargs = None,
        max_id: Optional[int] = None,
        shape: Optional[OneOrSequence[int]] = None,
        activations: Optional[OneOrManyHintOrType[nn.Module]] = None,
        activations_kwargs: Optional[OneOrManyOptionalKwargs] = None,
...
class FeaturizedMessagePassingRepresentation(TypedMessagePassingRepresentation):
    ...
    def __init__(
        self,
        triples_factory: CoreTriplesFactory,
        relation_representation: Optional[HintOrType[Representation]] = None,

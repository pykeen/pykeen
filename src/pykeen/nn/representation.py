...
class Representation(nn.Module, ExtraReprMixin, ABC):
    ...
    def __init__(
        ...
        normalizer: Optional[HintOrType[Normalizer]] = None,
...
class SubsetRepresentation(Representation):
    ...
    def __init__(
        self,
        max_id: int,
        base: Optional[HintOrType[Representation]] = None,
...
class Embedding(Representation):
    ...
    def __init__(
        ...
        initializer: Optional[Hint[Initializer]] = None,
        initializer_kwargs: Optional[Mapping[str, Any]] = None,
        constrainer: Optional[Hint[Constrainer]] = None,
...
class CompGCNLayer(nn.Module):
    ...
    def __init__(
        ...
        composition: Optional[Hint[CompositionModule]] = None,
...
class CombinedCompGCNRepresentations(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        entity_representations: Optional[HintOrType[Representation]] = None,
        entity_representations_kwargs: OptionalKwargs = None,
        relation_representations: Optional[HintOrType[Representation]] = None,
...
class CombinedRepresentation(Representation):
    ...
    def __init__(
        ...
        max_id: int,
        shape: Optional[OneOrSequence[int]] = None,
        base: Optional[OneOrManyHintOrType[Representation]] = None,
        base_kwargs: Optional[OneOrManyOptionalKwargs] = None,
...
class PartitionRepresentation(Representation):
    ...
    def __init__(
        ...
        assignment: torch.LongTensor,
        shape: Optional[OneOrSequence[int]] = None,
        bases: Optional[OneOrSequence[HintOrType[Representation]]] = None,
        bases_kwargs: Optional[OneOrSequence[OptionalKwargs]] = None,
        **kwargs,
    ):
        """
        Initialize the representation.
...
class BackfillRepresentation(PartitionRepresentation):
    ...
    def __init__(
        ...
        base: Optional[HintOrType[Representation]] = None,
        base_kwargs: OptionalKwargs = None,
        backfill: Optional[HintOrType[Representation]] = None,
...
class TensorTrainRepresentation(Representation):
    ...
    def __init__(
        ...
        bases: Optional[OneOrManyHintOrType] = None,
        bases_kwargs: Optional[OneOrManyOptionalKwargs] = None,
        **kwargs,
    ) -> None:
        """Initialize the representation.

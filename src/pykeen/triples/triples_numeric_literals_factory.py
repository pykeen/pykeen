...
import logging
from typing import Dict, Mapping, Optional, TextIO, Tuple, Union
...
class TriplesNumericLiteralsFactory(TriplesFactory):
    ...
    def from_path(
        ...
        path_to_numeric_triples: Union[str, TextIO] = None,  # TODO:  default value only to match signature..
        ...
        return cls.from_labeled_triples(
            triples=load_triples(path=path),
            numeric_triples=load_triples(path=path_to_numeric_triples),
    ...
    def from_labeled_triples(
        cls,
        triples: np.ndarray,
        numeric_triples: np.ndarray = None,  # TODO: default value only to match signature..
        create_inverse_triples: bool = False,
        entity_to_id: Optional[EntityMapping] = None,
        relation_to_id: Optional[RelationMapping] = None,
        compact_id: bool = True,

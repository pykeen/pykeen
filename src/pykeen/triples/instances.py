...
from ..typing import MappedTriples, MappedQuadruples
...
class QuadrupleInstances(Instances):
...
class SLCWAQuadrupleInstances(SLCWAInstances):
    ...
    def __init__(
        ...
        *,
        ...
        :param num_relations: >0
            The number of relations, passed to the negative sampler
        :param num_timestamps: >0
            The number of timestamps, passed to the negative sampler
        :param negative_sampler:
            The negative sampler, or a hint thereof
        :param negative_sampler_kwargs:
            Additional keyword-based arguments passed to the negative sampler
...
class LCWAQuadrupleInstances(LCWAInstances):
    """Quadruples and mappings to their indices for LCWA."""

    def __init__(self, *, pairs: np.ndarray, compressed: scipy.sparse.csr_matrix):
        """Initialize the LCWA instances.

        :param pairs: The unique pairs
        :param compressed: The compressed quadruples in CSR format
        """
        super().__init__(
            pairs=pairs,

...
def hpo_pipeline(
    *,
    ...
    filter_validation_when_testing: bool = True,
    # 9. Tracking
    result_tracker: Optional[HintType[ResultTracker]] = None,
    result_tracker_kwargs: Optional[Mapping[str, Any]] = None,
    # 6. Misc
    device: Optional[Hint[torch.device]] = None,
    #  Optuna Study Settings
    storage: Optional[Hint[BaseStorage]] = None,
    sampler: Optional[HintType[BaseSampler]] = None,
    sampler_kwargs: Optional[Mapping[str, Any]] = None,
    pruner: Optional[HintType[BasePruner]] = None,

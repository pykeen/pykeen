...
from ...nn.modules import MuRPInteraction
...
class MuRP(ERModel):
    r"""An implementation of MuRP from [balazevic2019b]_.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        r"""Initialize MuRP via the :class:`pykeen.nn.modules.MuRPInteraction` interaction.

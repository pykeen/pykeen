...
from pykeen.constants import EMBEDDING_DIMENSION_PRINT_MSG, EMBEDDING_DIMENSION_PROMPT_MSG, \
    ...
    MARGIN_LOSS_PRINT_MSG, MARGIN_LOSS_PROMPT_MSG, MARGIN_LOSS_ERROR_MSG, ENTITIES_NORMALIZATION_PRINT_MSG, \
...
from pykeen.utilities.cli_utils.cli_print_msg_helper import print_training_embedding_dimension_message, \
    ...
    print_entity_normalization_message, print_learning_rate_message, print_batch_size_message, \
...
def configure_distmult_training_pipeline(model_name):
    """

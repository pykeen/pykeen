...
def inspect_schedule(
    ...
    ... )
    [7, 15, 30, 45]
    >>> inspect_schedule(50, keeper="last", keeper_kwargs=dict(keep=2))
    [40, 50]
    >>> inspect_schedule(50, keeper="modulo", keeper_kwargs=dict(modulo=20))
    [20, 40]
    >>> inspect_schedule(50, keeper="explicit", keeper_kwargs=dict(keep=[15]))
    []
    >>> inspect_schedule(
    ...     50,
    ...     keeper="union",

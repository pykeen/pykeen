...
class LazyInductiveDataset(InductiveDataset):
    ...
    @property
    def transductive_training(self) -> TriplesFactory:  # noqa: D401
    ...
    @property
    def inductive_inference(self) -> TriplesFactory:  # noqa: D401
    ...
    @property
    def inductive_testing(self) -> TriplesFactory:  # noqa: D401
    ...
    @property
    def inductive_validation(self) -> TriplesFactory | None:  # noqa: D401

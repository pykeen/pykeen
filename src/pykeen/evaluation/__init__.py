...
However, given the fact that both the training and the test set usually only contain true facts, negative samples are generated by corrupting these positive triples.

...
from pykeen.constants import (
    ...
    EMBEDDING_DIMENSION_PRINT_MSG, EMBEDDING_DIMENSION_PROMPT_MSG, ENTITIES_NORMALIZATION_ERROR_MSG,
    ENTITIES_NORMALIZATION_PRINT_MSG, ENTITIES_NORMALIZATION_PROMPT_MSG, EPOCHS_ERROR_MSG, EPOCHS_PRINT_MSG,
    ...
    MARGIN_LOSS_ERROR_MSG, MARGIN_LOSS_PRINT_MSG, MARGIN_LOSS_PROMPT_MSG, NORMS_FOR_NORMALIZATION_OF_ENTITIES_ERROR_MSG,
    NORMS_FOR_NORMALIZATION_OF_ENTITIES_PRINT_MSG, NORMS_FOR_NORMALIZATION_OF_ENTITIES_PROMPT_MSG,
    NORMS_SCORING_FUNCTION_ERROR_MSG, NORMS_SCORING_FUNCTION_PRINT_MSG, NORMS_SCORING_FUNCTION_PROMPT_MSG,
    NORM_FOR_NORMALIZATION_OF_ENTITIES, NORM_SCORING_FUNCTION_ERROR_MSG, NORM_SCORING_FUNCTION_PRINT_MSG,
    NORM_SCORING_FUNCTION_PROMPT_MSG, NUM_EPOCHS, SCORING_FUNCTION_NORM,
)
